...
public class PollSettingsTest {
    ...
    public void should_set_value() {
        ...
        assertThat(diff, equalTo(Optional.of("pollSettings(betweenTaskTimeout=PT4S<PT1S,noTaskTimeout=PT5S<PT2S,fatalCrashTimeout=PT6S<PT3S,batchSize=2<1)")));
